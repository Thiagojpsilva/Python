...
# Centralizar entre 50 espaços - incluido o valor da string (Tem que ser usado em fstrings)
print(f'{variavel: ^50}')

# Manter a direita entre 50 espaços - incluido o valor da string (Tem que ser usado em fstrings)
print(f'{variavel: >50}')

# Manter a esquerda entre 50 espaços - incluido o valor da string (Tem que ser usado em fstrings)
print(f'{variavel: <50}.')
