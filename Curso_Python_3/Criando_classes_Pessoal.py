...
def Carga_dodos():       
    p1 = Pessoa(input("Nome:"),input("Idade:"),input("Altura:"),input("Peso:"))
    p2 = Pessoa(input("Nome:"),input("Idade:"),input("Altura:"),input("Peso:"))
    p3 = Pessoa(input("Nome:"),input("Idade:"),input("Altura:"),input("Peso:"))
